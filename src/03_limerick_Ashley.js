...
const prompt =
  `My name is ${name} and I am from ${town}. Create a haikus, a Japanese poem of seventeen syllables, in three lines of five, seven, and five, traditionally evoking images of the natural world, about me.`;
